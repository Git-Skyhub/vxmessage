...
import com.pt.vx.entity.WeatherOtherInfo;
...
public class MainConfig {
     ...
     * {{xxxSplit.DATA}}
     */
    public static String splitMessageFlag = "S";
     ...
     */
    static {
        weatherOtherInfos.add(new WeatherOtherInfo(0,"<10","天气冻死个人了，多穿几件衣服哦~"));
        weatherOtherInfos.add(new WeatherOtherInfo(1,"晴","今天天气晴朗，适合出去玩哦~"));
